...
from egrsdb.models.rstt.layers import (
    DecoderLayer,
    Downsample,
    EncoderLayer,
    InputProj,
...
checkpoint_folder = dirname(abspath(__file__))
RSTT_L = join(checkpoint_folder, "checkpoint/RSTT-L/f96d8w4h24816Ushape0res_1610000.pth")
RSTT_M = join(checkpoint_folder, "checkpoint/RSTT-M/f96d6w4h24816Ushape0res_1922000.pth")
RSTT_S = join(checkpoint_folder, "checkpoint/RSTT-S/f96d4w4h24816Ushape0res_1690000.pth")
