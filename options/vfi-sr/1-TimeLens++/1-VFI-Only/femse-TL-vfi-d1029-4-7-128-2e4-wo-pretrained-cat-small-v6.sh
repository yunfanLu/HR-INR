...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/1-VFI-Only/femse-TL-vfi-d1029-4-7-128-2e4-wo-pretrained-cat-small-v6.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/1-VFI-Only/femse-TL-vfi-d1029-4-7-128-2e4-wo-pretrained-cat-small-v6/" \
