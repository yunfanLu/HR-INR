...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/0-VFI-with-ADB-Pretrain/femse-TL-vfi-d1108-4-7-128-1e4-w-ADB-pretrained-wo-etpr-small-v3.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/0-VFI-with-ADB-Pretrain/femse-TL-vfi-d1108-4-7-128-1e4-w-ADB-pretrained-wo-etpr-small-v3/" \
