...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/1-VFI-Only/3-Skip-1-Skip/2-TimeLems++-BS-ERGB-Skip-1-Fintune-femse-TL-vfi-d1108-wo-etpr-v5.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/1-VFI-Only/3-Skip-1-Skip/2-TimeLems++-BS-ERGB-Skip-1-Fintune-femse-TL-vfi-d1108-wo-etpr-v5/" \
