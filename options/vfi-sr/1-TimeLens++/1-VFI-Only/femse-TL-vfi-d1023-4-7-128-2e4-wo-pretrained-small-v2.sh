...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/1-VFI-Only/femse-TL-vfi-d1023-4-7-128-2e4-wo-pretrained-small-v2.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/1-VFI-Only/femse-TL-vfi-d1023-4-7-128-2e4-wo-pretrained-small-v2/" \
