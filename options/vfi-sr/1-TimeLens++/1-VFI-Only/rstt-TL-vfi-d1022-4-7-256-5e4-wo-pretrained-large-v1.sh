...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/1-VFI-Only/rstt-TL-vfi-d1022-4-7-256-5e4-wo-pretrained-large-v1.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/1-VFI-Only/rstt-TL-vfi-d1022-4-7-256-5e4-wo-pretrained-large-v1/" \
