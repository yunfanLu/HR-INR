...
#   --yaml_file="options/vfi-sr/1-TimeLens++/1-VFI-Only/3-Skip-1-Skip-From-femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2/1-TimeLems++-BS-ERGB-Skip-3-Train-d1111-v8.yaml" \
#   --log_dir="./log/vfi-sr/1-TimeLens++/1-VFI-Only/3-Skip-1-Skip-From-femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2/1-TimeLems++-BS-ERGB-Skip-3-Train-d1111-v8/" \
...
python egrsdb/main.py \
  ...
  --log_dir="./log/vfi-sr/1-TimeLens++/1-VFI-Only/3-Skip-1-Skip-From-femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2/1-TimeLems++-BS-ERGB-Skip-3-Train-d1111-v8/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/1-TimeLens++/1-VFI-Only/3-Skip-1-Skip-From-femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2/1-TimeLems++-BS-ERGB-Skip-3-Train-d1111-v8/checkpoint.pth.tar" \
