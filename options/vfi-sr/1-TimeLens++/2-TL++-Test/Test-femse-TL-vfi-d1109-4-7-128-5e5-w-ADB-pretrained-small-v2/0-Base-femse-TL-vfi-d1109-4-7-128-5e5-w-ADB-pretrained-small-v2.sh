...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/0-VFI-with-ADB-Pretrain/femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/0-VFI-with-ADB-Pretrain/femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2/" \
  --alsologtostderr=True \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/femse-ADB-vfi-d1023-4-7-128-2e4-wo-pretrained-small-v2/checkpoint-010.pth.tar" \
