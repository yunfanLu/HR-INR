...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/4-TL++-Test/Test-femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2/1-TimeLems++-BS-ERGB-Skip-1-Test.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/4-TL++-Test/Test-femse-TL-vfi-d1109-4-7-128-5e5-w-ADB-pretrained-small-v2/1-TimeLems++-BS-ERGB-Skip-1-Test/" \
