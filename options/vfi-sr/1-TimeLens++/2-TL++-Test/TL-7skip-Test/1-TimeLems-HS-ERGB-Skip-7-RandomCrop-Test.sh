...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/1-TimeLens++/4-TL++-Test/TL-7skip-Test/1-TimeLems-HS-ERGB-Skip-7-RandomCrop-Test.yaml" \
  --log_dir="./log/vfi-sr/1-TimeLens++/4-TL++-Test/TL-7skip-Test/1-TimeLems-HS-ERGB-Skip-7-RandomCrop-Test/" \
