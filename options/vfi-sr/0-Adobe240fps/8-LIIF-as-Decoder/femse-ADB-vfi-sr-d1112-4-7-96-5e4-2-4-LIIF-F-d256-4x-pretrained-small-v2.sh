...
#SBATCH -p aiperf #  i64m1tga40u, i64m1tga800u, aiperf
...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-96-5e4-2-4-LIIF-F-d256-4x-pretrained-small-v2.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-96-5e4-2-4-LIIF-F-d256-4x-pretrained-small-v2/" \
