...
#   --yaml_file="options/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-64-5e5-2-4-LIIF-D-1x-8x-resume-pretrained-small-v10.yaml" \
#   --log_dir="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-64-5e5-2-4-LIIF-D-1x-8x-resume-pretrained-small-v10/" \
...
python egrsdb/main.py \
  ...
  --log_dir="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-64-5e5-2-4-LIIF-D-1x-8x-resume-pretrained-small-v10/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-64-5e5-2-4-LIIF-D-1x-8x-resume-pretrained-small-v10/checkpoint.pth.tar" \
  --RESUME_SET_EPOCH=False \
  --RESUME_STRICT=False