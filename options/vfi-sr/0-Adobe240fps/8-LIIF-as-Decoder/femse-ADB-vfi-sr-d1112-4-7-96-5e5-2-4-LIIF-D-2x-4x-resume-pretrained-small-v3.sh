...
#   --yaml_file="options/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-96-5e5-2-4-LIIF-D-2x-4x-resume-pretrained-small-v3.yaml" \
#   --log_dir="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-96-5e5-2-4-LIIF-D-2x-4x-resume-pretrained-small-v3/" \
...
python egrsdb/main.py \
  ...
  --log_dir="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-96-5e5-2-4-LIIF-D-2x-4x-resume-pretrained-small-v3/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-96-5e5-2-4-LIIF-D-2x-4x-resume-pretrained-small-v3/checkpoint.pth.tar" \
