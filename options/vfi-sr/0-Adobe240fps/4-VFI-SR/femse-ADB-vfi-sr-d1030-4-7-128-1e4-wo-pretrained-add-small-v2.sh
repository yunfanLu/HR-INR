...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/4-VFI-SR/femse-ADB-vfi-sr-d1030-4-7-128-1e4-wo-pretrained-add-small-v2.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/4-VFI-SR/femse-ADB-vfi-sr-d1030-4-7-128-1e4-wo-pretrained-add-small-v2/" \
