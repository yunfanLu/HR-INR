...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/4-VFI-SR/femse-ADB-vfi-sr-d1029-4-7-128-2e4-wo-pretrained-concat-small-ep50-step9-v4.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/4-VFI-SR/femse-ADB-vfi-sr-d1029-4-7-128-2e4-wo-pretrained-concat-small-ep50-step9-v4/" \
