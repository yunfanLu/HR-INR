...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/4-VFI-SR/femse-ADB-vfi-sr-d1030-4-7-128-5e4-2-4-wo-pretrained-small-v1.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/4-VFI-SR/femse-ADB-vfi-sr-d1030-4-7-128-5e4-2-4-wo-pretrained-small-v1/" \
