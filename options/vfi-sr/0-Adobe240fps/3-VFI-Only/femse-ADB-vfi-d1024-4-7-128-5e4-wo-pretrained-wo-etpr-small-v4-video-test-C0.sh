...
python egrsdb/main.py \
  ...
  --log_dir="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/CBMNet_EGVSR/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/femse-ADB-vfi-d1024-4-7-128-5e4-wo-pretrained-wo-etpr-small-v4/checkpoint-005.pth.tar" \
  --VISUALIZE=True \
  --TEST_ONLY=True
