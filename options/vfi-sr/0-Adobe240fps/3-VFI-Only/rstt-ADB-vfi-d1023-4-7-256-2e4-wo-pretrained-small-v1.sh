...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/3-VFI-Only/rstt-ADB-vfi-d1023-4-7-256-2e4-wo-pretrained-small-v1.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/rstt-ADB-vfi-d1023-4-7-256-2e4-wo-pretrained-small-v1/" \
