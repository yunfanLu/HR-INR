...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/3-VFI-Only/femse-ADB-vfi-d1024-4-7-128-5e4-wo-pretrained-wo-etpr-small-v4-video-test-R2.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/femse-ADB-vfi-d1024-4-7-128-5e4-wo-pretrained-wo-etpr-small-v4-video-test-R2/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/femse-ADB-vfi-d1024-4-7-128-5e4-wo-pretrained-wo-etpr-small-v4/checkpoint.pth.tar" \
  --VISUALIZE=True \
  --TEST_ONLY=True
