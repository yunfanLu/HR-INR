...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/3-VFI-Only/rstt-ADB-vfi-d1022-4-7-256-5e4-pretrained-small-v2.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/rstt-ADB-vfi-d1022-4-7-256-5e4-pretrained-small-v2/" \
