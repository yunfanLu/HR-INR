...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/3-VFI-Only/femse-ADB-vfi-d1024-4-7-128-5e4-wo-pretrained-wo-event-small-v2.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/3-VFI-Only/femse-ADB-vfi-d1024-4-7-128-5e4-wo-pretrained-wo-event-small-v2/" \
