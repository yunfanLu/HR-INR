...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/5-Ablation/femse-ADB-vfi-sr-d1104-4-7-128-5e4-4-4-pretrained-concat-dim960-small-v5.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/5-Ablation/femse-ADB-vfi-sr-d1104-4-7-128-5e4-4-4-pretrained-concat-dim960-small-v5/" \
