...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/5-Ablation/femse-ADB-vfi-sr-d1104-4-7-128-1e4-4-4-pretrained-add-small-v2.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/5-Ablation/femse-ADB-vfi-sr-d1104-4-7-128-1e4-4-4-pretrained-add-small-v2/" \
