...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/5-Ablation/femse-ADB-vfi-sr-d1104-4-7-196-1e4-2-4-pretrained-small-v1-test-Adobe-Average-vis1.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/5-Ablation/femse-ADB-vfi-sr-d1104-4-7-196-1e4-2-4-pretrained-small-v1-test-Adobe-Average-vis1/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/5-Ablation/femse-ADB-vfi-sr-d1104-4-7-196-1e4-2-4-pretrained-small-v1/checkpoint-006.pth.tar" \
