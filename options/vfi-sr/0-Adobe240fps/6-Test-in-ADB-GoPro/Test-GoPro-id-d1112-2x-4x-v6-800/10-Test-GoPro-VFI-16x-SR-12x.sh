...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id1112-LIIF-2x-4x/10-Test-GoPro-VFI-16x-SR-12x.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id1112-LIIF-2x-4x-N/10-Test-GoPro-VFI-16x-SR-12x-LIIF-v4/" \
  --alsologtostderr=True \
  --RESUME_PATH="log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-96-LIIF-5e4-Other-1e6-1-4-LIIF-D-2x-4x-resume-pretrained-small-v5-800/checkpoint-004.pth.tar" \
  --VISUALIZE=False \
  --TEST_ONLY=True
