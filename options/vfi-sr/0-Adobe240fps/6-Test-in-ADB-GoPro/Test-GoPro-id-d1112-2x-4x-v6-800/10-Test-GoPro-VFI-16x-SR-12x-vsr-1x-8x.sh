...
python egrsdb/main.py \
  ...
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/8-LIIF-as-Decoder/femse-ADB-vfi-sr-d1112-4-7-64-LIIF-5e4-Other-1e6-1-4-LIIF-D-1x-8x-resume-pretrained-small-v9/checkpoint-006.pth.tar" \
  --VISUALIZE=False \
  --TEST_ONLY=True
