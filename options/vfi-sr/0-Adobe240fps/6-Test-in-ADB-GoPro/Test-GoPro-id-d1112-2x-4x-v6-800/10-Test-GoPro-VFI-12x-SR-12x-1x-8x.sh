...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id-d1112-2x-4x-v6-800/10-Test-GoPro-VFI-12x-SR-12x.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id-d1112-2x-4x-v6-800/10-Test-GoPro-VFI-12x-SR-12x/" \
