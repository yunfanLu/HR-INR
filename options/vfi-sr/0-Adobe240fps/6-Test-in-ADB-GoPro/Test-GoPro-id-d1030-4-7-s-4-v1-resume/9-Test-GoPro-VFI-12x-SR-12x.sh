...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id-d1030-4-7-s-4-v1-resume/9-Test-GoPro-VFI-12x-SR-12x.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id-d1030-4-7-s-4-v1-resume/9-Test-GoPro-VFI-12x-SR-12x/" \
