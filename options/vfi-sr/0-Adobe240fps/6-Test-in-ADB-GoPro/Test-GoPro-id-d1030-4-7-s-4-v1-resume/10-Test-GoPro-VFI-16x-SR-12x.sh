...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id-d1030-4-7-s-4-v1-resume/10-Test-GoPro-VFI-16x-SR-12x.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id-d1030-4-7-s-4-v1-resume/10-Test-GoPro-VFI-16x-SR-12x/" \
  --alsologtostderr=True \
  --RESUME_PATH="./log/vfi-sr/0-Adobe240fps/4-VFI-SR/femse-ADB-vfi-sr-d1030-4-7-128-5e4-2-4-wo-pretrained-small-v1-resume/checkpoint-023.pth.tar" \
  --VISUALIZE=False \
  --TEST_ONLY=True
