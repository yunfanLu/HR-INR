...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-id-d1104-4-4-v1/3-GoPro-Center-femse-ADB-vfi-sr-d1104-4-7-128-1e4-4-4-pretrained-add-small-v2-Test-GoPro-Center-VFI-7-SR-4-I-180.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-id-d1104-4-4-v1/3-GoPro-Center-femse-ADB-vfi-sr-d1104-4-7-128-1e4-4-4-pretrained-add-small-v2-Test-GoPro-Center-VFI-7-SR-4-I-180/" \
