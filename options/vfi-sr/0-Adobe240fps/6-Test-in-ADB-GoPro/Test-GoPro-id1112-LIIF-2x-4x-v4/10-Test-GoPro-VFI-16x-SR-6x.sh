...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id1112-LIIF-2x-4x/10-Test-GoPro-VFI-16x-SR-6x.yaml" \
  --log_dir="./log/vfi-sr/0-Adobe240fps/6-Test-in-ADB-GoPro/Test-GoPro-id1112-LIIF-2x-4x-N/10-Test-GoPro-VFI-16x-SR-6x/" \
