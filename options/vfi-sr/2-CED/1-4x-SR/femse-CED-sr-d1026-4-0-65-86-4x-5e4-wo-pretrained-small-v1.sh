...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/2-CED/1-4x-SR/femse-CED-sr-d1026-4-0-65-86-4x-5e4-wo-pretrained-small-v1.yaml" \
  --log_dir="./log/vfi-sr/2-CED/1-4x-SR/femse-CED-sr-d1026-4-0-65-86-4x-5e4-wo-pretrained-small-v1/" \
