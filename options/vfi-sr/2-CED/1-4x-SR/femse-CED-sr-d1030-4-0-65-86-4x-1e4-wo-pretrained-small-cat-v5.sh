...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/2-CED/1-4x-SR/femse-CED-sr-d1030-4-0-65-86-4x-1e4-wo-pretrained-small-cat-v5.yaml" \
  --log_dir="./log/vfi-sr/2-CED/1-4x-SR/femse-CED-sr-d1030-4-0-65-86-4x-1e4-wo-pretrained-small-cat-v5/" \
