...
python egrsdb/main.py \
  --yaml_file="options/vfi-sr/2-CED/1-4x-SR/femse-CED-sr-d1027-4-0-65-86-4x-5e4-wo-pretrained-small-add-v3.yaml" \
  --log_dir="./log/vfi-sr/2-CED/1-4x-SR/femse-CED-sr-d1027-4-0-65-86-4x-5e4-wo-pretrained-small-add-v3/" \
